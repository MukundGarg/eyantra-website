...
"[project]/components/AnimationProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AnimationProvider({ children }) {
        ...
        "AnimationProvider.useEffect": ()=>{
            ...
            function initScrollReveals() {
                if (prefersReducedMotion) {
                    document.querySelectorAll(".reveal, .reveal-left, .reveal-scale").forEach({
                        "AnimationProvider.useEffect.initScrollReveals": (el)=>{
                            el.classList.add("revealed");
                        }
                    }["AnimationProvider.useEffect.initScrollReveals"]);
                    return;
                }
                const observer = new IntersectionObserver({
                    "AnimationProvider.useEffect.initScrollReveals": (entries)=>{
                        entries.forEach({
                            "AnimationProvider.useEffect.initScrollReveals": (entry)=>{
                ...
                document.querySelectorAll(".reveal, .reveal-left, .reveal-scale").forEach({
                    "AnimationProvider.useEffect.initScrollReveals": (el)=>observer.observe(el)
                }["AnimationProvider.useEffect.initScrollReveals"]);
            }
            function initNavbarScroll() {
                ...
                function onScroll() {
                    if (!ticking) {
                        window.requestAnimationFrame({
                            "AnimationProvider.useEffect.initNavbarScroll.onScroll": ()=>{
                ...
                onScroll();
                return ({
                    "AnimationProvider.useEffect.initNavbarScroll": ()=>window.removeEventListener("scroll", onScroll)
                })["AnimationProvider.useEffect.initNavbarScroll"];
            }
            initScrollReveals();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        ...
        fileName: "[project]/components/AnimationProvider.tsx",
        lineNumber: 70,
        columnNumber: 10
    }, this);
}
...
//# sourceMappingURL=_141h9u0._.js.map