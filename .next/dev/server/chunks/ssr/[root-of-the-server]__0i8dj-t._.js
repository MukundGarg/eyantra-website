...
async function ProjectsPage() {
    const { data: projects = [] } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').order('display_order', {
        ascending: true
    });
